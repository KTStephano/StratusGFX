...
layout (std430, binding = VPL_PREV_LIGHT_DATA_BINDING_POINT) readonly buffer inputBlock1 {
    VplData lightData[];
};
...
layout (std430, binding = VPL_PREV_SHADOW_ATLAS_INDICES_BINDING_POINT) readonly buffer inputBlock4 {
