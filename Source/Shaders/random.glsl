...
void typeOffset(inout vec2 x) { x += vec2(0, x.x + 8192); }
void typeOffset(inout vec3 x) { x += vec3(0, 0, x.x + x.y + 8192); }
void typeOffset(inout vec4 x) { x += vec4(0, 0, 0, x.x + x.y + x.z +8192); }
