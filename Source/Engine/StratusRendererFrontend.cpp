...
namespace stratus {
    ...
    void RendererFrontend::UpdateCascadeData_() {
        ...
        // cameraWorldTransform[3] = glm::vec4(glm::vec3(c.GetPosition().x, 0.0f, c.GetPosition().y), 1.0f);
        ...
        for (usize i = 0; i < numCascades; ++i) {
            ...
            const glm::mat4 cascadeTexelOrthoProjection(glm::vec4(2.0f / dk, 0.0f, 0.0f, 0.0f), 
                                                       glm::vec4(0.0f, 2.0f / dk, 0.0f, 0.0f),
