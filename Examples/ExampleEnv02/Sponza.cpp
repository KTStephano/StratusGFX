...
public:
    ...
    virtual bool Initialize() override {
        ...
        INSTANCE(RendererFrontend)->SetSkybox(stratus::ResourceManager::Instance()->LoadCubeMap("../resources/textures/Skyboxes/learnopengl/sbox_", stratus::ColorSpace::SRGB, "jpg"));
