...
public: 
    ...
    virtual bool Initialize() override {
        ...
        stratus::Async<stratus::Entity> e = stratus::ResourceManager::Instance()->LoadModel("../Resources/Bathroom.glb", stratus::ColorSpace::SRGB, true, stratus::RenderFaceCulling::CULLING_NONE);
        ...
        settings.SetSkyboxIntensity(stratus::Float8Bit(1));
